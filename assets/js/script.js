// DISCORD ALERT
function discord_alert(){alert("my username is: kyb3rcipher#9104");}
...
(function () {
    ...
    onvisible.add("#image01", { style: "fade-down", speed: 1000, intensity: 5, delay: 0, staggerOrder: "", replay: false });
    onvisible.add("#text03", { style: "fade-down", speed: 1000, intensity: 5, delay: 0, staggerOrder: "", replay: false });
    onvisible.add("#buttons01", { style: "fade-down", speed: 1000, intensity: 5, delay: 0, replay: false });
})();
